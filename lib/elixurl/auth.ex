defmodule Elixurl.Auth do
  ...
  alias Elixurl.Auth.{User, UserToken, UserNotifier}
  ...
  See `Elixurl.Auth.User.email_changeset/3` for a list of supported options.
  ...
  See `Elixurl.Auth.User.password_changeset/3` for a list of supported options.
