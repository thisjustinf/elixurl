defmodule ElixurlWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ElixurlWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ElixurlWeb.Gettext, "errors", msg, opts)
    end
  end
